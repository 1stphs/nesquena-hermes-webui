...
def switch_profile(name: str, *, process_wide: bool = True) -> dict:
    ...
    from api.core.config import STREAMS, STREAMS_LOCK, reload_config
    ...
    try:
        from api.core.config import DEFAULT_WORKSPACE as _DW
        ...
        try:
            from api.core.config import DEFAULT_WORKSPACE as _DW2
