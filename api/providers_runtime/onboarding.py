...
from api.authn.auth import is_auth_enabled
...
from api.providers_runtime.providers import _write_env_file  # shared impl with _ENV_LOCK (#1164)
from api.core.workspace import get_last_workspace, load_workspaces
...
def apply_onboarding_setup(body: dict) -> dict:
    ...
    try:
        from api.core.profiles import _reload_dotenv
